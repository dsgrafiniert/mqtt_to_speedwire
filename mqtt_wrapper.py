...
def run_emeter_simulator(payload: dict):
    try:
        ...
        packet.addMeasurementValue(emeterPacket.SMA_NEGATIVE_ACTIVE_POWER, round(payload["active_power"] * 10))
        packet.addCounterValue(emeterPacket.SMA_NEGATIVE_ACTIVE_ENERGY, round(payload["total_forward_energy"] * 1000 * 3600))
